...
echo "   Database (from host): postgres://neon:npg@localhost:5432/neondb?sslmode=disable"
echo "   Database (from app container): postgres://neon:npg@neon-local:5432/neondb?sslmode=disable"
echo ""
